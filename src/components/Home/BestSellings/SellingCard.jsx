...
const SellingCard = ({ img, title }) => {
  return (
    <div className=" flex flex-col gap-2 text-left md:w-full w-60 xl:px-4 md:px-3 px-3 transition-transform duration-300 ease-in-out transform hover:scale-105">
