...
const BannerSection = () => {
  return (
    <section className="relative w-full h-[500px] md:mt-[6rem] mt-[9rem] mb-[10rem]">
      ...
      <div className=" md:w-1/2  w-[20rem] md:mr-10 md:h-[600px] md:-mt-[5rem] -mt-[6rem] md:h-66 h-[15rem] md:right-0 justify-center  right-[15%] bannerImg flex transition-transform duration-300 ease-in-out transform hover:scale-105">
